...
////////////////////////////////////////////////////////////////////////////////////////
provider "hcloud" {
  token = var.peerdas_hcloud_token
}
////////////////////////////////////////////////////////////////////////////////////////
//                                        VARIABLES
////////////////////////////////////////////////////////////////////////////////////////
variable "peerdas_hcloud_token" {
  type        = string
      ...
      for i in range(0, vm_group.count) : {
        ...
        vms = {
          "${i + 1}" = {
            ...
            vm_group.validator_start) / vm_group.count), vm_group.validator_end)},supernode:${try(vm_group.supernode, false)}"
...
resource "local_file" "ansible_inventory" {
      ...
      hosts = merge(
        {
          for key, server in hcloud_server.main : "${key}" => {
            ...
            tags            = server.labels
            supernode       = title(server.labels.supernode)
  ...
  filename = "../../../ansible/inventories/devnet-5/hetzner_inventory.ini"
}
